...
ModelTrainerConfig, ModelEvaluationConfig, ModelPusherConfig, TrainingPipelineCofig
...
class Configuration:
    ...
    def get_data_ingestion_config(self) ->DataIngestionConfig:
        try:
            ...
            data_insgestion_config=DataIngestionConfig(
            ...
            logging.info(f"Data Ingestion Config:{data_insgestion_config}")
            return data_insgestion_config
        except Exception as e:
            raise HousingException(e,sys) from e
    ...
    def get_data_transformation_config(self) ->DataTransformationConfig:
        try:
            ...
            data_transformation_config=DataTransformationConfig(
                ...
                trasnformed_test_dir=transformed_test_dir
            )
